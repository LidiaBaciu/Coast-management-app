...
public class ModelMapper {
    ...
    public static PollResponse mapPollToPollResponse(Poll poll, Map<Long, Long> choiceVotesMap, User creator, Long userVote) {
        ...
        RoleName grantedAuthority = creator.getRoles().stream().findFirst().get().getName();
        UserSummary creatorSummary = new UserSummary(creator.getId(), creator.getUsername(), creator.getName(), grantedAuthority);
